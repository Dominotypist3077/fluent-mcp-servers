...
if (args.includes('--help') || args.includes('-h')) {
	console.log(`
fluent-affiliate-mcp — MCP server for the FluentAffiliate REST API

Usage:
  fluent-affiliate-mcp              Start the MCP server (stdio transport)
  fluent-affiliate-mcp --version    Show version
  fluent-affiliate-mcp --help       Show this help
...
Environment variables:
  FLUENTAFFILIATE_URL              WordPress site URL (e.g. https://my.site.com)
  FLUENTAFFILIATE_USERNAME         WordPress username
  FLUENTAFFILIATE_APP_PASSWORD     WordPress Application Password
  FLUENTAFFILIATE_TIMEOUT          Request timeout in ms (default: 30000)
`)
	process.exit(0)
}
