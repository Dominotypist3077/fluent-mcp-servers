...
if (args.includes('--help') || args.includes('-h')) {
	console.log(`
fluent-support-mcp — MCP server for the Fluent Support REST API

Usage:
  fluent-support-mcp              Start the MCP server (stdio transport)
  fluent-support-mcp --version    Show version
  fluent-support-mcp --help       Show this help
...
Environment variables:
  FLUENTSUPPORT_URL              WordPress site URL (e.g. https://my.site.com)
  FLUENTSUPPORT_USERNAME         WordPress username
  FLUENTSUPPORT_APP_PASSWORD     WordPress Application Password
  FLUENTSUPPORT_TIMEOUT          Request timeout in ms (default: 30000)
`)
	process.exit(0)
}
