...
if (args.includes('--help') || args.includes('-h')) {
	console.log(`
fluent-community-mcp — MCP server for the Fluent Community REST API

Usage:
  fluent-community-mcp              Start the MCP server (stdio transport)
  fluent-community-mcp --version    Show version
  fluent-community-mcp --help       Show this help
...
Environment variables:
  FLUENTCOMMUNITY_URL              WordPress site URL (e.g. https://my.site.com)
  FLUENTCOMMUNITY_USERNAME         WordPress username
  FLUENTCOMMUNITY_APP_PASSWORD     WordPress Application Password
  FLUENTCOMMUNITY_TIMEOUT          Request timeout in ms (default: 30000)
`)
	process.exit(0)
}
